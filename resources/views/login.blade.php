        ...
        <form action="login" method="post">
            ...
            <div class="card bg-white/50 rounded-3xl min-w-[400px] ">
                <div class="card-body">
                    ...
                    <p class="text-center text-slate-500">Don't have an account? <a class="hover:font-semibold text-slate-600" href="#">Register</a></p>
                </div>
            </div>
        </form>
    </div>
...
{{-- <section class="flex items-center min-h-screen">
    ...
    <div class="flex flex-1 bg-white items-center justify-center">
