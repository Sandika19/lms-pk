<div>
    <form wire:submit="login" class="mx-auto flex w-full max-w-lg flex-col rounded-xl border border-border bg-backgroundSecondary sm:p-24 p-8">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="form-field">
                <div class="form-control">
                    <a wire:navigate href='/register' class="link link-underline-hover link-primary text-sm">Don't have an account? Sign up</a>
                </div>
            </div>
        </div>
    </form>
